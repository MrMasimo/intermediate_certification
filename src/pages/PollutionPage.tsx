...
const tableColumns: TableProps<GeoObjectType>['columns'] = [
    ...
    },
    {
        ...
        dataIndex: 'airPollution',
        key: 'no2',
        render: (airPollution) => <>{airPollution.components.no2}</>
    },
    {
        title: 'Озон',
        dataIndex: 'airPollution',
        key: 'o3',
        render: (airPollution) => <>{airPollution.components.o3}</>
    },
    {
        title: 'Диоксид серы',
        dataIndex: 'airPollution',
        key: 'so2',
        render: (airPollution) => <>{airPollution.components.so2}</>
    },
    {
        title: 'PM2.5',
        dataIndex: 'airPollution',
        key: 'pm2_5',
        render: (airPollution) => <>{airPollution.components.pm2_5}</>
    },
    {
        title: 'PM10',
        dataIndex: 'airPollution',
        key: 'pm10',
        render: (airPollution) => <>{airPollution.components.pm10}</>
    },
    {
            ...
            >
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: 'Введите название местоположения'
                        },
                        {
                            min: 3,
