...
const tableColumns: TableProps<PollutionType>['columns'] = [
    ...
    },
    {
        title: 'Окись азота',
        key: 'no2',
        render: (pollution) => <>{pollution.components.no2}</>
    },
    {
        title: 'Озон',
        key: 'o3',
        render: (pollution) => <>{pollution.components.o3}</>
    },
    {
        title: 'Диоксид серы',
        key: 'so2',
        render: (pollution) => <>{pollution.components.so2}</>
    },
    {
        title: 'PM2.5',
        key: 'pm2_5',
        render: (pollution) => <>{pollution.components.pm2_5}</>
    },
    {
        title: 'PM10',
        key: 'pm10',
        render: (pollution) => <>{pollution.components.pm10}</>
    },
    {
